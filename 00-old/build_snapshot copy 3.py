...
Fetches all 14 metrics for 12 countries from FRED + Yahoo Finance,
...
COUNTRY_CONFIG = {
    ...
    "RUS": {
        ...
        "fred": {
            ...
            # Keeping them here — script will gracefully fall back if dead
            "inflation":      "RUSCPIALLMINMEI",
            "policy_rate":    "IRSTCI01RUM156N",
            # gdp_growth: NAEXKP01RUQ657S likely dead post-sanctions — uses fallback
            # unemployment: LRHUTTTTRUM156S likely dead — uses fallback
            # bond_yield_10y: IRLTLT01RUM156N likely dead — uses fallback
            # currency: DEXRUS likely dead (MOEX halted USD trading Jun 2024) — uses fallback/Yahoo
